...
from double_stream.engine.libra_double_stream_chain import FullLibraOpDSChain  # noqa: E402
from single_stream.engine.libra_single_stream_chain import FullLibraOpSSChain  # noqa: E402
...
class LibraOpMSAT(nn.Module):
    ...
    def __init__(self, gs_msat, n_sa_pure, n_vl, device, dtype=torch.bfloat16):
        ...
        self.ds_chain = FullLibraOpDSChain(
        ...
        self.ss_chain = FullLibraOpSSChain(
