...
from double_stream.engine.libra_expanded_double_stream_chain import FullExpandedLibraOpDSChain
from single_stream.engine.libra_expanded_single_stream_chain import FullExpandedLibraOpSSChain
import torch
...
class LibraOpExpandedMSAT(nn.Module):
    ...
    def __init__(self, gs_msat, n_sa_pure, n_vl, n_physics, device, dtype=torch.bfloat16):
        ...
        self.ds_chain = FullExpandedLibraOpDSChain(
        ...
        self.ss_chain = FullExpandedLibraOpSSChain(
